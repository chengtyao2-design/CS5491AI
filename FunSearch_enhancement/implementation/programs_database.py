  ...
  def _generate_prompt(
    ...
    header = dataclasses.replace(
        ...
        docstring=(f'Improved version of `{self._function_to_evolve}_v{next_version - 1}`.\n'
                   f'INSTRUCTIONS:\n'
                   f'1. Analyze the previous heuristics and their scores.\n'
                   f'2. Write a detailed "Thought:" process in this docstring explaining your new strategy.\n'
                   f'3. Implement the Python code below the docstring.'),
    )
